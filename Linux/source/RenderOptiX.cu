...
bool RenderOptiX(SOptiXRenderParams<SH_degree>& params_OptiX, bool inference) {
	...
	try {
		...
		launchParams.traversable = params_OptiX.IAS;
...
template bool RenderOptiX<0>(SOptiXRenderParams<0>& params_OptiX, bool inference);

// *************************************************************************************************

template bool RenderOptiX<1>(SOptiXRenderParams<1>& params_OptiX, bool inference);

// *************************************************************************************************

template bool RenderOptiX<2>(SOptiXRenderParams<2>& params_OptiX, bool inference);

// *************************************************************************************************

template bool RenderOptiX<3>(SOptiXRenderParams<3>& params_OptiX, bool inference);

// *************************************************************************************************

template bool RenderOptiX<4>(SOptiXRenderParams<4>& params_OptiX, bool inference);