...
bool DumpParametersToPLYFileOptiX(SOptiXRenderParams<SH_degree>& params_OptiX, char *dirPath) {
	...
	try {
		...
		sprintf(fPath, "%s/iter_%d.ply", dirPath, params_OptiX.epoch);
		f = fopen(fPath, "wb");
...
template bool DumpParametersToPLYFileOptiX<0>(SOptiXRenderParams<0> &params_OptiX, char *dirPath);

// *************************************************************************************************

template bool DumpParametersToPLYFileOptiX<1>(SOptiXRenderParams<1> &params_OptiX, char *dirPath);

// *************************************************************************************************

template bool DumpParametersToPLYFileOptiX<2>(SOptiXRenderParams<2> &params_OptiX, char *dirPath);

// *************************************************************************************************

template bool DumpParametersToPLYFileOptiX<3>(SOptiXRenderParams<3> &params_OptiX, char *dirPath);

// *************************************************************************************************

template bool DumpParametersToPLYFileOptiX<4>(SOptiXRenderParams<4> &params_OptiX, char *dirPath);