...
def setup_ambient_light():
    ...
    background_node.inputs["Color"].default_value = (
        ...
        1.0,
        1.0,
    )  # White color for ambient light
    background_node.inputs["Strength"].default_value = (
        1.0  # Adjust the strength as needed
    )
...
def render(_path, _cam_json_path=None, _wanted_cam_idx=None):
    ...
    bpy.context.scene.eevee.taa_render_samples = (
        64  # Increase samples for better quality
    )
